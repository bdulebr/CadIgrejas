...
urlpatterns = [
    ...
    path('drive/pasta/renomear/<int:pasta_id>/', views.renomear_pasta, name='renomear_pasta'),
    path('drive/pasta/excluir/<int:pasta_id>/', views.excluir_pasta, name='excluir_pasta'),
    ...
    path('drive/arquivo/renomear/<int:arquivo_id>/', views.renomear_arquivo, name='renomear_arquivo'),
    path('drive/arquivo/excluir/<int:arquivo_id>/', views.excluir_arquivo, name='excluir_arquivo'),
