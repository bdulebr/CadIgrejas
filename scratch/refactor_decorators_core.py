...
def refactor_core():
    filepath = 'C:/Users/MarcosLira/Desktop/Marcos/Projeto/core/views.py'
    ...
    content = content.replace('@user_passes_test(is_super_admin)', "@requer_permissao('sysadmin', 'editar')")

    with open(filepath, 'w', encoding='utf-8') as f:
        f.write(content)

refactor_core()
print("Refactored core/views.py")
